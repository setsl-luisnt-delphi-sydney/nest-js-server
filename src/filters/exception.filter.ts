...
export class AllExceptionsFilter implements ExceptionFilter {
    ...
    if (this.isBadRequest(exception)) {
      ...
      exception.response.message.map(v => {
        violations[v.property] = Object
          .values(v.constraints).join(', ')
          .split(`${v.property} `).join('')
      })
      data["body"] = req.body
    ...
    if (this.isEntityNotFound(exception)) {
      const message = exception.message
        .replace(/\"/gi, '')
        .replace('Could not find any entity of type ', 'Não foi possível encontrar em ')
  ...
  isNotFoundRouter = e => (e["response"] !== undefined) && (e["response"]["error"] !== undefined) && (e["response"]["error"] === 'Not Found')
  isBadRequest = e => (e["response"] !== undefined) && (e["response"]["error"] !== undefined) && (e["response"]["error"] === 'Bad Request')
  isEntityNotFound = e => (e["name"] !== undefined) && (e["name"] === "EntityNotFound")
}
