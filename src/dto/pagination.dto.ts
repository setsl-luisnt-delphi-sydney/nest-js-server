...
export class DataDto {
  ...
  constructor(pagination: Pagination, records: number) {
    this.url = pagination.url;
    this.page = new Page();
    this.page.value = parseInt(pagination.page) || 1;
    this.page.limit = parseInt(pagination.limit) || 10;
    this.page.rows = 0;
    this.page.offset = 0;
